...
| 2026-05-20 00:00 | H-11 | 076d932 | docs(crm): add CRM module spec, designer prompt, and 4-sprint implementation plan; ROADMAP H-11 row for cross-venture customer/lead management with GDPR/CAN-SPAM compliance rails |
| 2026-05-23 12:00 | H-11 | 7dcbacc | feat(crm): Sprint 1 — migration (contacts lifecycle/compliance cols, crm_audit_log, crm_consent), rewrote broken crm_ops, moved suppression gate into send_email, wired sample/order/outreach/revenue ingestion through upsert_contact; verified end-to-end on Postgres |
