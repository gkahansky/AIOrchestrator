...
| D-14 | Management Web App | System | 2026-03-31 | Full FastAPI + React admin app. Backend on Railway (jobs, dashboard, finance, settings, auth, venture order triggers, Celery worker). Frontend on Vercel at planBadmin.com. Google OAuth login. PostgreSQL job state. Human review gate (approve/reject) with UI. All 3 ventures triggerable from UI. |
