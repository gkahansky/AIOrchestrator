...
const TIERS = [
  {
    ...
    label: "Starter",
    price: "$49",
    description: "Summary + key takeaways",
  },
  {
    id: "standard",
    label: "Standard",
    price: "$79",
    description: "Full show notes + timestamps",
  },
  {
    id: "premium",
    label: "Premium",
    price: "$119",
    description: "Full notes + social clips + newsletter",
  },
] as const
          ...
          {[
            ...
            <div key={i} className="text-center">
              <div className="w-8 h-8 rounded-full bg-tertiary-fixed flex items-center justify-center mx-auto mb-1">
                <span className="text-xs font-label font-bold text-on-tertiary-fixed-variant">
                  {i + 1}
                </span>
              </div>
