...
def generate_thumbnail(
    ...
    Args:
        ...
        bg_prompt:               Clip-specific Imagen background prompt from generate_thumbnail_headline.
                                 When provided, replaces the generic fallback prompt.
...
def _gemini_thumbnail(
    ...
    bg_prompt (from generate_thumbnail_headline) is content-specific per clip.
    Falls back to a generic hook-themed prompt when not provided.
    """
